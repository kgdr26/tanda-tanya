...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-6 col-lg-3 align-self-center">
                        <a href="" class="logo"><img src="{{ asset('assets/icon/icon1.png') }}" alt="" style="max-width: 4rem;"></a>
                    </div>
            ...
            <div class="slide-widgest-wrap" id="slide-widgest">
                <div class="side-widgest" id="side-content">
                    ...
                    <div class="side-content">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sint ratione reprehenderit, error
                            qui enim sit ex provident iure, dolor, nulla eaque delectus, repudiandae commodi. Velit
                            assumenda odit quisquam at, error suscipit unde, necessitatibus ipsum ratione excepturi
                            ducimus labore, totam dolorem.</p>
                    </div>
                            ...
                            <div class="col-lg-7">
                                <div class="wlc-title white">
                                    <h1 class="fadeInDown animated"><span>imagination</span> is more important
                                        than knowledge</h1>
                                    <p class="fadeInDown animated">Together we the people achieve more than any single
                                        person <br>could ever do alone. </p>
                ...
                <div class="row">
                        ...
                        <div class="about-shape">
                            <div class="about-img-section about-img-section1 text-center">
                                <a id="play-video" class="video-play-button" href="#"
                                    data-video-id="p_ph8Zx1Z9E"><span></span></a>
                    ...
                    <div class="col-lg-6 offset-lg-1 align-self-center">
                        <div class="heading white">
                            ...
                            <p>Spend more time focusing on the important aspects of your business. Turn to McCartney HR
                                LLC in Brooklyn, NY for HR solutions. As an advanced virtual HR company, we are offering
                                online HR systems that can be customized depending on your business needs.</p>
    ...
    <script src="{{asset('assets/js/plugins/easypiechart.min.js')}}"></script>
    <script src="{{asset('assets/js/plugins/animatenumber.min.js')}}"></script>
    <script src="{{asset('assets/js/plugins/circle-progress.js')}}"></script>
    <script src="{{asset('assets/js/plugins/bars.js')}}"></script>
    <script src="{{asset('assets/js/plugins/appear.js')}}"></script>
    <script src="{{asset('assets/js/plugins/jquery.hoverdir.js')}}"></script>
    <script src="{{asset('assets/js/plugins/isotop.v3.0.4.min.js')}}"></script>
